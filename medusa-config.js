...
{
  resolve: `./dist/services/aurapay`,
  options: {
    api_key: process.env.AURAPAY_API_KEY,
    webhook_secret: process.env.AURAPAY_WEBHOOK_SECRET,
    api_url: process.env.AURAPAY_API_URL || "https://api.aurapay.com",
  },
},
fileServicePlugin,
{
