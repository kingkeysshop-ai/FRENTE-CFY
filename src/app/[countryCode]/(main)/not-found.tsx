...
export default function NotFound() {
  return (
    <div className="min-h-[calc(100vh-200px)] bg-[#0a0a0a] flex items-center justify-center px-4">
      <div className="flex flex-col items-center text-center gap-6 max-w-lg">
        ...
        <div className="flex flex-col small:flex-row gap-3 w-full small:w-auto">
          <Link
            href="/"
            className="px-6 py-3 bg-[#facc15] text-[#0a0a0a] font-black rounded-xl text-sm hover:bg-[#e6b800] transition-all duration-200 hover:shadow-lg hover:shadow-yellow-400/20 active:scale-95 inline-flex items-center gap-2"
          >
            <Home size="18" color="#0a0a0a" /> Ir al Inicio
          </Link>
          <Link
            href="/store"
            className="px-6 py-3 border border-[#2a2a2a] text-[#888888] font-bold rounded-xl text-sm hover:border-yellow-400/40 hover:text-white transition-all duration-200 inline-flex items-center gap-2"
          >
