    ...
    >
      ...
      <div className="flex flex-col gap-2">
        <h1 className="text-3xl font-black text-white">
          Tu carrito está <span className="text-[#facc15]">vacío</span>
        </h1>
      ...
      <LocalizedClientLink
        href="/store"
        className="px-8 py-3 bg-[#facc15] text-[#0a0a0a] font-bold rounded-lg hover:bg-[#e6b800] hover:-translate-y-0.5 transition-all duration-200"
      >
        🔑 Ver Productos
      </LocalizedClientLink>
    </div>
