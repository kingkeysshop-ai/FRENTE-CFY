      ...
      {payment && (
        <>
          <div className="flex flex-col gap-1 min-w-[140px]">
            <p className="text-[#facc15] text-xs font-bold uppercase tracking-wider mb-1">Método de Pago</p>
          ...
          <div className="flex flex-col gap-1 min-w-[180px]">
            <p className="text-[#facc15] text-xs font-bold uppercase tracking-wider mb-1">Detalles</p>
            <div className="flex items-center gap-2">
              <span className="text-[#888888] text-sm" data-testid="payment-amount">
